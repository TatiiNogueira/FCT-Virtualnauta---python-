...
list = ('pika','beautifulsoup4','bs4','flask','matplotlib','numpy','openpyxl','pyPDF2','selenium','pandas','django','gunicorn','pyautogui','pywin32','keyboard','opencv-python','pyautogui')
